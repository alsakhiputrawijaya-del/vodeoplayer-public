...
**"Dua Keranjang Migrasi"** di `LINTASAI_WORKFLOWS_v1.md` §4.5.
...
(mis. `npx lintasai doctor`, `npx lintasai update`). Terdampak: semua project ber-kit yang masih
...
Jalur resmi: `npx lintasai update` — atau `npm create lintasai@latest` kalau tak punya akses repo.

**Langkah migrasi (urut):**
1. Update kit lewat jalur resmi: `npx lintasai update` — cadangan `.claude-kit.backup-<cap-waktu>`
