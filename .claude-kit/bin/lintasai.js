...
const shouldPassProjectRoot = ["init", "update", "uninstall", "team-setup", "rollback", "preflight", "enable-risk-gate", "enable-preflight-ci", "access-verify", "perf-budget", "env-keys", "migrate-project-card", "project-map"].includes(command);
