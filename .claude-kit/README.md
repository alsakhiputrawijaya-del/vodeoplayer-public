...
## 🌟 Versi stabil sekarang: **v3.1.0** (2026-07-23)
...
|---|---|---|
| 1 | **AI auto-pakai aturan tiap sesi** — kernel `AGENTS.md` dibaca native semua alat AI | Mirip **WhatsApp template balasan otomatis** — AI ikut aturan tim tanpa kamu reminder tiap kali |
...
├── AGENTS.md                              ← KERNEL aturan (sumber tunggal; dibaca native semua alat AI — ADR-032)
...
| `AGENTS.md` | **Kernel aturan** (sumber tunggal, ADR-032) - dibaca native Codex/Kimi/Cursor + Claude via `@import` | Kit |
...
## Penutup
Kalau masih bingung, buka Claude Code **di folder proyek setelah install kelar**, lalu chat: "Halo, aku staff baru. Tolong cek install kit + briefing aturan dasar." AI akan auto-detect kondisi dan apply Guided Step-by-Step Workflow (lihat `.claude-kit/rules/4.3-guided-step-by-step.md`). Selamat ngoding bareng AI yang patuh!
