...
|---|---|---|---|
| a11y | frontend | aksesibilitas, a11y, wcag, disabilitas, … | `skills/a11y/SKILL.md` |
...
| design-direction | frontend | desain, design, tata-letak, layout, … | `skills/design-direction/SKILL.md` |
...
| 🔒 next-core | stack | next.js, nextjs, app-router, server-component, … | `skills/next-core/SKILL.md` |
...
| presentasi | frontend | presentasi, slide, slides, deck, … | `skills/presentasi/SKILL.md` |
...
| react-patterns | stack | react, react-patterns, react-testing-library, react-useeffect, … | `skills/react-patterns/SKILL.md` |
