...
- **Batasi akses** — RLS default-deny (`RLS_SETUP_PROMPT.md`), pisah data sensitif, kolom rahasia jangan ikut ke API/`SELECT *` (rujuk `skills/python/SKILL.md` DRF `__all__`).
