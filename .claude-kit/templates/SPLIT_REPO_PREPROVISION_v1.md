...
- Isi 2 baris pemuat: `@./AGENTS.md` (kernel aturan tim) + `@./AGENTS.override.md` (pakai format `CLAUDE.md.template`).
...
- [ ] `AGENTS.md` akar ada (kernel aturan tim).
- [ ] `CLAUDE.md` ada + berisi 2 baris pemuat (`@./AGENTS.md` + `@./AGENTS.override.md`).
