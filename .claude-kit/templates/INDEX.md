# Index - Daftar Lengkap Dokumen lintasAI v3.1.0
...
| File | Fungsi |
|---|---|
| AGENTS.md (akar project) | Kernel aturan universal (ADR-032) — dibaca native Codex/Kimi + auto-loaded tiap sesi Claude via `CLAUDE.md` |
