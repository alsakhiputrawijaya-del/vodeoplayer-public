...
- **Kernel:** `./AGENTS.md` di root proyek (+ override `./AGENTS.override.md`); rak kit di `./.claude-kit/`
- **Override per proyek:** `./AGENTS.override.md` di root proyek
...
### Aturan kerja inti
- **Cek kit terpasang:** baca aturan dari kernel `./AGENTS.md` (+ override `./AGENTS.override.md` kalau ada); rak kit di `./.claude-kit/`. Kalau `./.claude-kit/` tidak ada → minta user pasang kit dulu (`npm create lintasai`).
...
> "Pembuatan catatan massal (bulk-bootstrap) selesai. **Aturan baca dokumen tim aktif** (`rules/7.3a-read-code-before-edit.md`):
...
> v1.5 · 2026-06-01 · komplement aturan baca dokumen `rules/7.3a-read-code-before-edit.md` (READ-MINIMAL)
...
### Aturan kerja
- Patuhi `rules/module/7-documentation.md` - format `.md` standar.
...
### Aturan kerja
- Patuhi aturan kit: kernel `./AGENTS.md` (+ rak rujukan `./.claude-kit/rules/`).
- Patuhi `./AGENTS.override.md` proyek kalau ada - itu override sebagian untuk proyek ini.
