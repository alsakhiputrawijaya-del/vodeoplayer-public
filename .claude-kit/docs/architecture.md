...
aturannya sendiri: `CLAUDE.md` meng-`@import` kernel tiap sesi — di client kernelnya `AGENTS.md` akar +
`AGENTS.override.md` (ADR-032); di repo kit ini sesi dev memuat kernel-developer `lintasAI.md`.
...
- `CLAUDE.md` → `@import AGENTS.md` (kernel akar, ADR-032) + `@import AGENTS.override.md` — **aturan inti AI**
  (auto-load tiap sesi di client; Codex/Kimi/Cursor baca `AGENTS.md` native. Di repo ini `CLAUDE.md` memuat
  kernel-developer `lintasAI.md`).
