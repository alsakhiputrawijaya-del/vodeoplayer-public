...
Satu perintah yang menjalankan **semua pemeriksa mutu sekaligus** + menambah **cek kelengkapan rilis**, lalu memilah hasil jadi **GENTING / PENTING / RAPIKAN** dengan satu kode-keluar (exit-code). Ini "gerbang sebelum menyatakan selesai/rilis" (aturan §4.6 QA+QC — `rules/module/4.6-done-gate.md`).
