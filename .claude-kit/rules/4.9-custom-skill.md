...
> Dibaca AI saat client bikin/panggil skill kustom (inti kini berumah di berkas ini; jalan masuk = pemicu di `rules/INDEX.md` + registry skill — kernel lama §4.9 `CLAUDE_universal_v1` kini diarsip). Tiap client punya keahlian beda → bisa bikin skill sendiri tanpa terpaku skill bawaan.
