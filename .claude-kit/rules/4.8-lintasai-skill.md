...
> Dibaca AI saat user ketik **"lintasAI skill"** (pemicu = entri §4.8 di `rules/INDEX.md`; inti kini berumah di berkas ini — kernel lama §4.8 `CLAUDE_universal_v1` kini diarsip). Berlaku di SEMUA project yang install lintasAI. Nama lama "scan lintasAI function" = alias sama.
