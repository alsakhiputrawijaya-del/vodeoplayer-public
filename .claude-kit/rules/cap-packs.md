...
- **Reuse-first:** pack **merujuk-silang** ke checklist divisi / stack-pack / pack lain yang sudah ada — **JANGAN menyalin** (mis. detail keamanan sesi → rujuk `skills/owasp/SKILL.md`; upload aman → rujuk pack `upload-storage`).
