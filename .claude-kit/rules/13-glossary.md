...
> Dipindah dari kernel lama §13 (`CLAUDE_universal_v1`, kini diarsip; kernel = `AGENTS.md`) — rumah hidup = berkas ini. Dibaca AI saat perlu arti istilah. Untuk staff non-programmer: `docs/GLOSSARY_NON_PROGRAMMER.md`.
