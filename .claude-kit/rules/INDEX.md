...
| skill-design-direction | skills/design-direction/SKILL.md | Skill Arah Desain: design token + anti-generik (arah desain + cocok-domain, daftar JANGAN, 9 pola) | "skill design-direction" / bikin-ubah tampilan visual |
| skill-a11y | skills/a11y/SKILL.md | Skill Aksesibilitas: WCAG 2.2 AA + 12 pola a11y React + ARIA, microcopy, 4 state UI | "skill a11y" / aksesibilitas / alur / detail frontend |
...
| §4.14-1 | skills/next-core/SKILL.md | Next.js inti: batas Server/Client, secret tak bocor, Server Action auth, middleware sadar-versi | Kerja di project Next.js (deteksi `next`, berkas `*.tsx`) |
| §4.14-1b | skills/react-patterns/SKILL.md | Pola & performa React: anti-waterfall, bundle, re-render, key stabil, tes RTL, race useEffect, Motion, compound components | Kerja React (performa/tes komponen/animasi/custom hooks) |
| §4.14-1c | skills/presentasi/SKILL.md | Deck presentasi HTML/CSS: slide muat-viewport, navigasi keyboard/sentuh, 12 preset gaya | Bikin/ubah presentasi/slide/deck/pitch |
