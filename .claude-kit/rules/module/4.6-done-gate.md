...
### Berlaku di mana
Berlaku di tiap project yang memasang lintasAI — kernel `AGENTS.md` di akar project dibaca native (Codex/Kimi/Cursor) + oleh Claude via `CLAUDE.md` → `@./AGENTS.md`; berkas ini dibaca on-demand lewat `rules/INDEX.md`. "Rilis" = apa pun bentuk "SELESAI" (merge PR, deploy, serah-terima fitur, tandai done).
