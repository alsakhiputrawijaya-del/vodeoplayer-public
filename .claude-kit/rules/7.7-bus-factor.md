...
> Dipindah dari kernel lama §7.7 (`CLAUDE_universal_v1`, kini diarsip) — aturan WAJIB-scoring kini di `rules/module/7-documentation.md` (7.7 Bus Factor Scorer). Dibaca saat menilai file CRITICAL.
