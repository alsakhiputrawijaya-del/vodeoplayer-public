...
// Yang MEMUTUSKAN relevan-tidaknya tetap penalaran otak Claude/Kimi (rules/4.13-division-skills.md,
// rules/4.17-empower-dont-cage.md). Pemetaan di bawah bukan hal baru: ia turunan dari jalan-pintas yang SUDAH tertulis di kernel lama
// (§4.13 lama, 15 capability pack — kini rules/4.13-division-skills.md) - yang berubah cuma SIAPA yang mengingatnya
