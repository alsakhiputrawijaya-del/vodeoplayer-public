...
//   scanDocs:     [{ rel, text }] berkas kit yang boleh merujuk (AGENTS.md, prompts, templates, docs).
//   sectionFiles: [{ rel, text }] berkas di rules/ (rel diawali 'rules/'), TANPA INDEX.md.
//   indexText:    isi rules/INDEX.md (null = INDEX hilang).
// Berkas RUJUKAN BESAR yang doktrin §6 (rules/module/6-token-economy.md) tandai eksplisit "Grep kata-kunci/anchor dulu,
...
export const BERKAS_ALWAYS_LOAD = ['AGENTS.override.md.template', 'CLAUDE.md.template', 'AGENTS.md', 'AGENTS.override.md', 'CLAUDE.md']
...
// AGENTS.md SENGAJA dikecualikan: ia memang berkas always-load (kernel) yang dibaca utuh tiap sesi,
