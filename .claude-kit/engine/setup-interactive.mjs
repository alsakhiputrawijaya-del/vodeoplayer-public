...
export function detectAgentsFormat(content) {
  // Penanda: header override Pola B · marker kernel ADR-032 · path kit '.claude-kit/' (mencakup
...
// bp = { Protected: true|false|null, Reason, DefaultBranch } (pasca perampingan: pemanggil kit selalu
// mengoper null -> cabang netral "cek manual di GitHub"; bentuk objek dipertahankan utk kompatibilitas).
