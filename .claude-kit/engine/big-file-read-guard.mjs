...
// (perlu dibaca utuh untuk dipahami/diedit) dan BUKAN berkas aturan inti (AGENTS.md /
// AGENTS.override.md / CLAUDE.md, memang dibaca penuh) -> DITAHAN-LUNAK: pesan mengarahkan ke Grep/offset.
...
// 'client.md' = nama kernel lama pra-ADR-032, dipertahankan sebagai jaring aman untuk client lama.
const ATURAN_INTI = new Set(['client.md', 'claude.md', 'agents.md', 'agents.override.md'])
