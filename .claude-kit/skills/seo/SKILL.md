...
7. 💡 **SARAN — menulis konten/copy off-page (anti "AI-slop").** *AI-slop* = tulisan hasil AI yang bertele-tele/generik/berpola khas robot. Prinsip: hindari frasa khas robot, jaga gerbang mutu copy, konsisten brand voice, tulis dari sumber (source-first). Butuh pendalaman → bungkus skill kustom (§4.9, `docs/SKILLS_LOCAL.md`). Opt-in, bukan baseline.
...
- 📐 **Ambang Core Web Vitals + a11y** (LCP/INP/CLS + kontras + `alt`) → §1b + §10 aturan inti; detail a11y/frontend → `skills/a11y/SKILL.md`.
...
- 🗃️ **LATAR — SEO off-page** (kata kunci/backlink/konten anti AI-slop) = di luar baseline ini → skill kustom §4.9 (`docs/SKILLS_LOCAL.md`).
