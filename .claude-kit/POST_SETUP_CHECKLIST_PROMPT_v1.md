...
>
> Prosedur Aktivasi Pasca-Instalasi (Install Senyap) = berkas ini (sumber tunggal alurnya: `JALANKAN_KIT.md`).
...
**Kategori-kategori itu dinilai dari aturan bahasa `AGENTS.md` §1 + Reference Card translasi jargon `rules/ref-jargon-card.md`** (definisi terpusat "PRE-SEND CHECKLIST §2.1.1" kernel lama sudah dipensiun — ADR-031). Jangan salin-ulang di sini supaya tak drift.
...
- Prosedur aktivasi pasca-instalasi (Install Senyap) = berkas INI sendiri (sumber alur: `.claude-kit/JALANKAN_KIT.md`)
- `.claude-kit/rules/4.4-audit-post-setup.md` (audit on-demand) + `.claude-kit/rules/4.2-pattern-driven.md` (refactor on-demand)
