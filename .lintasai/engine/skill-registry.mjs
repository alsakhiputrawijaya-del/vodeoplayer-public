...
// Baca registry.json (dipakai dispatcher). FAIL-SAFE: tak ada / korup -> []. Cari di root, .lintasai/,
// ATAU kit/. Kandidat `kit/` = repo-dev setelah pemisahan client/dev (isi kit/ = yang jadi .lintasai/
// di client). Ditaruh TERAKHIR dengan sengaja: kalau project client kebetulan punya folder bernama
// `kit/`, salinan kit asli di `.lintasai/` tetap menang lebih dulu.
