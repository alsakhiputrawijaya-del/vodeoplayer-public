...
// Bentuk hook = acuan templates/hooks/risk-gate.settings.example.json (matcher + command). Dikunci tes
...
runHookCli(import.meta.url, {
  ...
  successLines: [
    'LANGKAH WAJIB: buka chat BARU (hook dimuat saat sesi mulai), lalu uji-jalan - lihat docs/risk-gate.md langkah 4.',
