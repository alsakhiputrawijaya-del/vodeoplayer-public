...
if (isMain) {
  // CLI tipis untuk uji-banding: `node engine/safety.mjs resolve <root> <relPath>` -> "ACCEPT<TAB>path" / "REJECT".
  ...
  if (cmd === 'resolve' && root != null && rel != null) {
    ...
    console.error('Pakai: node engine/safety.mjs resolve <root> <relPath>')
    process.exit(2)
  }
}
