...
// Bentuk hook = acuan templates/hooks/plan-mode-gate.settings.example.json (matcher + command).
...
runHookCli(import.meta.url, {
  ...
  successLines: [
    ...
    'LANGKAH WAJIB: buka chat BARU (hook dimuat saat sesi mulai) - lihat docs/plan-mode-gate.md.',
