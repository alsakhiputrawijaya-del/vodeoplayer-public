...
- [ ] Kalau error ini kelas-bug yang bisa kambuh → tawarkan penjaga (tes regresi / langkah preflight), rujuk `skills/cakupan-tes/SKILL.md` + Buku Pelajaran (templates/BUKU_PELAJARAN.example.md).
