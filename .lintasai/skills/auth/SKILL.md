...
divisi: keamanan
pemicu: [login, masuk, daftar-akun, form-pendaftaran, pendaftaran-member, bikin-akun, sign-up, sign-in, akun, auth, oauth, sso, sesi, session, peran, role, hak-akses, rbac, password, otentikasi, otorisasi]
rawan_keamanan: true
