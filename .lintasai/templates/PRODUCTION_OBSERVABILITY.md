...
> Pelengkap, BUKAN pengganti: backup DB = `backup-schemas.yml` · standar log & larangan telan-error = `skills/backend/SKILL.md` §2 butir 5. File ini **mengangkat observability jadi standar wajib-sebelum-online** + langkah konkret 3 pilar.
